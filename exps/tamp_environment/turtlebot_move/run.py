...
def main():
    ...
    parser.add_argument('--max-samples', default=500, type=int, help='Max num samples for motion planning')
    ...
    parser.add_argument('--delta', default=0.10, type=float, help='Difference between the hallway width and the largest object that needs to fit thorugh the hallway')
